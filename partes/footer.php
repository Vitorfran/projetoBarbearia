  ...
  <footer>
    <div class="footer-container">
      <div class="footer-grid">
        <div class="footer-section">
          <h3>Endereço</h3>
          <p>Avenida Visconde de Suassuna, PE</p>
        </div>
        
        <div class="footer-section">
          <h3>Informações de Contato</h3>
          <p>Fale conosco</p>
          <a href="tel:99999999999">(81) 9 8892-3216</a>
          <a href="mailto:sualoja@gmail.com">cortaibarbearia@gmail.com</a>
        </div>
    ...
    <a href="<?php echo $redirectUrl; ?>">
      ...
      <div class="social-media">
        ...
        <a href="https://www.instagram.com/cortai_senac/" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://maps.app.goo.gl/r9p3C7kBuFCGvoeK9" target="_blank" rel="noopener noreferrer">
      ...
      <div class="footer-copyright">
        <p> 2025 Cortaí. Todos os direitos reservados.</p>
