...
(1, 'Cortes Modernos', 'Cortes modernos, estilizados e feitos sob medida para seu estilo pessoal.', 60, 50.00, 1),
(2, 'Barba', 'Barba com estilo e atenção aos detalhes. Seu visual, nossa paixão.', 30, 30.00, 1),
(3, 'Sobrancelha', 'Transforme o olhar com sobrancelhas feitas sob medida para seu rosto.', 25, 25.00, 1);
